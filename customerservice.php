        ...
        <section id="team">
            <div class="aboutus">
                <div class="card">
                    ...
                    <div class="social-icons">
                        <a href="https://facebook.com/FranzKennethNaces21"><i class="fab fa-facebook"></i></a>
                ...
                <div class="card">
                    ...
                    <div class="social-icons">
                        <a href="https://facebook.com/seisadkiddddd"><i class="fab fa-facebook"></i></a>
                ...
                <div class="card">
                    ...
                    <div class="social-icons"> 
                        <a href="https://facebook.com/Conquerre28"><i class="fab fa-facebook"></i></a>
            ...
            <div class="aboutus">
                <div class="card">
                    ...
                    <p>Project Manager</p>
                    <div class="social-icons">
                        <a href="https://facebook.com/vndesagun"><i class="fab fa-facebook"></i></a>
                ...
                <div class="card">
                    ...
                    <div class="social-icons">
                        <a href="https://www.facebook.com/share/12De3K6Xewt/"><i class="fab fa-facebook"></i></a>
                ...
                <div class="card">
                    ...
                    <div class="social-icons">
                        <a href="https://www.facebook.com/share/1BVxtCXHHh/?mibextid=wwXIfr"><i class="fab fa-facebook"></i></a>
